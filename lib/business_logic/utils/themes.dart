  ...
  static ThemeData getTheme({required bool darkMode}) {
    ...
    if (darkMode) {
      return ThemeData(
          ...
          primaryColor: Color(0xff5b886d),
          primaryColorDark: Color(0xff456753),
          primaryColorLight: Color(0xff5b886d),
          accentColor: Color(0xff73a989),
          toggleableActiveColor: Color(0xff4D725C),
          colorScheme: ColorScheme.dark(
            primary: Color(0xff5b886d),
            secondary: Color(0xff73a989),
          ),
          ...
          textTheme: TextTheme(
            ...
            bodyText2: TextStyle(fontSize: desktop ? 15 : 14, color: Colors.grey, fontWeight: FontWeight.w300),
      ...
      return ThemeData(
          ...
          primaryColor: Color(0xff5b886d),
          primaryColorDark: Color(0xff456753),
          primaryColorLight: Color(0xff8CBE8B), // Sticker color, find alt?
          accentColor: Color(0xff73a989),
          toggleableActiveColor: Color(0xff4D725C),
